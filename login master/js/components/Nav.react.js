...
class Nav extends Component {
  render() {
    ...
    const navButtons = this.props.loggedIn ? (
        <div>
          <Link to="/dashboard" className="btn btn--dash btn--nav">SWAPI</Link>
        ...
        <div>
          <Link to="/register" className="btn btn--login btn--nav">Add new User</Link>
    ...
    return(
      <div className="nav">
        <div className="nav__wrapper">
          <Link to="/" className="nav__logo-wrapper"><h1 className="nav__logo">Star&nbsp;War&nbsp;Page</h1></Link>
          { navButtons }
        </div>
      </div>
    );
